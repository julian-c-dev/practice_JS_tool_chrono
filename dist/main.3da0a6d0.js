...
var valueStartBtn = document.querySelector('input[name="start"]');
var screenChrono = document.getElementById("chronoTime");
var root = document.documentElement;
var get_color = document.querySelector("input[type='color'");
var get_size = document.querySelector("select");
var get_contact = document.getElementById("contactMenu"); // ~ Chrono Behaviour
